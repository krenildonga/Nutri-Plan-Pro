                ...
                <div className="space-y-6">
                    {loading ? (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button className={`p-3 rounded-xl transition-all flex items-center gap-2 font-bold text-sm ${expandedHistory === item._id ? 'bg-slate-900 text-white' : 'bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white shadow-sm'}`}>
                                        ...
                                        <div className="pt-8 border-t border-slate-100 space-y-10">
                                            ...
                                            <div className="space-y-6">
                                                <h4 className="text-lg font-black text-slate-800 flex items-center gap-2">
                                                    <FaUtensils className="text-emerald-500" /> Archived Menu Plan
                                                </h4>
                        ...
                        <div className="glass-card-premium rounded-[3rem] p-20 text-center space-y-6 animate-fadeIn">
                            ...
                            <Link to="/get-diet-recommendation" className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-600 text-white font-black rounded-2xl shadow-xl shadow-emerald-100 hover:bg-slate-900 transition-all active:scale-95 uppercase tracking-widest text-sm">
                                Start Analysis
                            </Link>
                        </div>
                    )}
