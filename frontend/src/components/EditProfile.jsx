            ...
            <nav aria-label="Breadcrumb" className="flex z-10">
                <ol className="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
                    ...
                    <li className="relative flex items-center">
                        ...
                        <Link to="/editprofile" className="flex h-10 items-center bg-white pe-4 ps-8 text-xs font-medium transition hover:text-gray-900">
                            Edit Profile
                        </Link>
                    </li>
                </ol>
                    ...
                    <div className='flex flex-col justify-center items-center w-[80%] sm:w-[70%] bg-[#b9d7d9] rounded-md h-[390px]'>
                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col w-[90%] sm:w-[70%]'>
                            <div className='flex items-center bg-gray-100 my-2 rounded-md w-full'>
                                <FaUser className='m-2 text-[#164043]' />
                                <input id="name" name="name" type="text" className='bg-transparent border-l-2 p-2 outline-none w-[80%]' placeholder='Your Name' value={userData.name} onChange={handleChange} required />
                            </div>
                                ...
                                <div className='flex flex-col rounded-md w-[49%]'>
                                    ...
                                    <div className='flex items-center bg-gray-100 my-2 rounded-md w-full'>
                                        <div className='p-2 flex-grow'>
                                            <input type="radio" id="male" name="gender" className='bg-transparent p-2 outline-none accent-[#164043] rounded-md' checked={userData.gender === 'male'} onChange={() => setUserData({ ...userData, gender: 'male' })} />
                                            <label htmlFor="male" className='text-black my-1 px-1 text-sm'>Male</label>
                                        </div>
                                        <div className='p-2 flex-grow'>
                                            <input type="radio" id="female" name="gender" className='bg-transparent p-2 outline-none accent-[#164043] rounded-md' checked={userData.gender === 'female'} onChange={() => setUserData({ ...userData, gender: 'female' })} />
                                            <label htmlFor="female" className='text-black my-1 px-1 text-sm'>Female</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
